    ...
    <div className='row mt-4 container-fluid '>
      <div className='col ' style={{ height: "500px", width: "100%", overflow: "scroll" }} id='scroll' >
        <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0" >
          ...
          <div className='row' id="scrollspyHeading2"><img alt="nothing to preview" src='images/user/NoteWave/NoteWave 0.png' style={{ maxWidth: "100%" }}></img></div>
          <div className='row mt-2' id="scrollspyHeading2"><img alt="nothing to preview" src='images/user/NoteWave/NoteWave 1.png' style={{ maxWidth: "100%" }}></img></div>
          <div className='row mt-2' id="scrollspyHeading2"><img alt="nothing to preview" src='images/user/NoteWave/NoteWave 2.png' style={{ maxWidth: "100%" }}></img></div>
