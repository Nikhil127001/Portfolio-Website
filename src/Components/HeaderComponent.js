...
const HeaderComponent = (props) => {
  ...
  return (<>
    ...
    <Nav className={`  justify-content-center  Nikhilx`} activeKey="/home" style={{ backgroundColor: 'white' }}>
      <Nav.Item >
      ...
      <Nav.Item >
        <div className="form-check form-switch">
          <input className="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" onClick={change} defaultChecked />
